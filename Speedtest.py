...
class SpeedtestMod(loader.Module):
    ...
    strings = {
        "name": "Speedtest",
        "author": "@nalinormods",
        "running": "<emoji document_id=5444955879109574821>🍭</emoji> <b>Checking your internet speed...</b>",
        "result": (
    ...
    strings_ru = {
        ...
        "running": "<emoji document_id=5444955879109574821>🍭</emoji> <b>Проверяем скорость интернета...</b>",
        "result": (
