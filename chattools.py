...
# .admins | .bots   | .common | .chatdump | .addusers
# .report
# ---------------------------------------------------------------------------------
...
class ChatMod(loader.Module):
    ...
    async def useridcmd(self, message):
        ...
        await message.edit(
            f"<bName</b> <code>{user.first_name}</code>\n"
    ...
    async def invitecmd(self, message):
        ...
        if not args and not reply:
            return await message.edit("<b>Where arguments?</b>")
        ...
        try:
            ...
            m = "<b>I don't have rights!</b>"
        except ChatWriteForbiddenError:
            m = "<b>I don't have rights!</b>"
        except ChannelPrivateError:
            m = "<b>I don't have rights!</b>"
        except UserKickedError:
            m = "<b>User already kicked!</b>"
        except BotGroupsBlockedError:
            m = "<b>Bot have banned.</b>"
        except UserBlockedError:
            m = "<b>User have banned.</b>"
        except InputUserDeactivatedError:
            m = "<b>User account deleted.</b>"
        except UserAlreadyParticipantError:
            m = "<b>User already in group.</b>"
        except YouBlockedUserError:
            m = "<b>You are blocked this user.</b>"
    ...
    async def leavecmd(self, message):
        ...
        args = utils.get_args_raw(message)
        if message.is_private:
            return await message.edit("<b>This isn't chat!</b>")
        if args:
